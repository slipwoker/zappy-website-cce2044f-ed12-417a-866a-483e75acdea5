    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "יוסי לזרוף - צלם אופנה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://qaapi.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'cce2044f-ed12-417a-866a-483e75acdea5',
                    name: data.name || '',
                    email: data.email || '',
